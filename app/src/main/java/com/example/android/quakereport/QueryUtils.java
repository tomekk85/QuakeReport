...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray earthquakedArray =JsonResponse.getJSONArray("features");
            for(int i=0;i<earthquakedArray.length();i++){
            JSONObject currentEarthquake = earthquakedArray.getJSONObject(i);
